namespace CC__Assignment
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("Invalid input. Please enter a valid number for pounds.");
            }
            Console.WriteLine("=======================================================================");
            ...
            {
                Console.WriteLine("Invalid input. Please enter a valid number for Fahrenheit.");
            }
            Console.WriteLine("=======================================================================");
            ...
            // Output ages and average age of students
            Console.WriteLine("Ages of students:");
            foreach (var studentAge in ages)
            {
...
and items needed to cast his ultimate skills the {ultimateskill}, to defeat the heroes. THE END.";
            ...
            static void PrintNumberPattern1()
            {
                Console.Write("Input: ");
            ...
            static void PrintNumberPattern2()
            {
                Console.Write("Input: ");
                if (int.TryParse(Console.ReadLine(), out int a) && a > 0)
                {
            ...
            static void PrintNumberPattern3()
            {
                Console.Write("Input: ");
                if (int.TryParse(Console.ReadLine(), out int a) && a > 0)
                {
